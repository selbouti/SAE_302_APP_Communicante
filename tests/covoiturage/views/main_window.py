...
from views.disponibilite_view import DisponibiliteView   # ✅ AJOUT
...
class MainWindow(QStackedWidget):
    ...
    def __init__(self):
        ...
        self.profile_page = ProfileView(self.user_controller)
        self.voiture_page = VoitureView(self.user_controller)
        self.dispo_page = DisponibiliteView(self.user_controller)   # ✅ AJOUT
        ...
        self.addWidget(self.voiture_page)
        self.addWidget(self.dispo_page)   # ✅ AJOUT
    ...
    def show_voiture_page(self):
        self.setCurrentWidget(self.voiture_page)

    def show_dispo_page(self):                 # ✅ AJOUT
        self.setCurrentWidget(self.dispo_page)
